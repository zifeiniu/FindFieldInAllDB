...
namespace FindFieldInAllDB
{
    public class SQLHelper
    {
        static SQLHelper() 
        {
            ...
            {
                SQLHelper.SetStrConn(System.Configuration.ConfigurationManager.ConnectionStrings["default"].ConnectionString);
            }
        }
        ...
        public static void SetStrConn(string _strConn)
        {
            strConn = _strConn;
        }
